...
Agendas=Adherencia;
Start Time=1543932861
Report Resolution=20
Terminate Time=1543932946
Return code=0
Failure reason=Test passed
SessionCreatedVersion=Version 11.2.0.058.00  Supports 128 bit SSL 
SessionLastSavedVersion=Version 11.2.0.058.00  Supports 128 bit SSL 
[Adherencia]
...
[Default Report Tree]
Generators=Total;;Adherencia::Total;;
[TotalDefault Report]
Type=Web
Measurements=Hits Per Second;;Load Size;;Round Time;;Throughput (Bytes Per Second);;
...
AutoAdjust=1
[Adherencia::TotalDefault Report]
Type=Emulation
Measurements=Response Time;;
[Response TimeAdherencia::TotalDefault Report]
Measurement Types=10;;
[10Response TimeAdherencia::TotalDefault Report]
maxValue=100.000000
